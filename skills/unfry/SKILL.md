---
name: unfry
description: Brain dump — summarize this session, extract insights and next steps
allowed-tools: Write
---

# /unfry — Session Brain Dump
...
Optionally saves to a file so the next session starts with full context.
...
```
🧠 /unfry — [date] — [project name if obvious]
...
The point of `/unfry` is not logging. It's **offloading**.
